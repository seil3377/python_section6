...
#form_class = uic.loadUiType("D:/Atom_Workspace/section6/ui/you_viewer_v1.0.ui")[0]
#pyuic5 -x you_viewer_v1.0.ui -o YouViewerLayout.py
...
class Main(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.youtb = None
        self.youtb_fsize = 0
        #배경음악 Thread 작업 선언(Qthread 사용 안할 경우)
        self.initIntroThread()
        #QSound.play("D:/Atom_Workspace/section6/resource/intro.wav")
    ...
    def initIntroThread(self):
        ...
        #Worker To thread 전환(QObject에서 제공하는 메소드)
    ...
    #활동 로그 저장(또는 DB사용)
        with open('D:/Atom_Workspace/section6/log/log.txt','a') as f:
            f.write(app_msg+'\n')

    @pyqtSlot(int) #int가 넘어온다
